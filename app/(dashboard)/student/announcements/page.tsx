...
export default function StudentAnnouncementsPage() {
  ...
  return (
    <div>
      <TopBar title="Announcements" subtitle="Notices and updates from administration" />
              ...
              <div key={a.id} className="announcement-card" style={{ padding: "1.25rem 1.5rem" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "0.625rem" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: "0.72rem", color: "hsl(215 16% 45%)" }}>{a.createdBy.name} · {format(new Date(a.createdAt), "MMMM d, yyyy")}</div>
                  </div>
                </div>
